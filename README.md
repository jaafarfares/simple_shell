...
[execute.c](./execute.c)|executes the shell
[main.h](./main.h)|header file
[built_in.c](./built_in.c)|built_in functions
[tools.c](./tools.c)|helper functions
[printenv.c](./printenv.c)| print env
[_getenv.c](./_getenv.c)|gets inputted env
[getpath.c](./getpath.c)|gets current working directory
[prompt.c](./prompt.c)|print prompt
[splits.c](./splits.c)|split the line
...
* Blog:
	- [Medium](https://medium.com/@4300/simple-shell-in-c-ce9f5965ed3b)

---

## Authors
* **Jaafar Fares** - [Jaafar-github](https://github.com/jaafarfares)
* **Achref Haddaji** - [Achref-github](https://github.com/Achref-haddaji)
* **Louay Chab** - [Louay-github](https://github.com/louay66)
